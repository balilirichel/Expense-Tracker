...
const Login = () => {
    ...
    <div className="w-screen flex flex-col items-center justify-center min-h-screen max-h-screen overflow-x-hidden">
        <div className="flex bg-white w-full rounded-lg shadow-xl border-t-2 border-r-2 overflow-hidden mx-auto max-w-xs md:max-w-sm lg:max-w-3xl xl:max-w-4xl">
            ...
            <div className="w-full p-8 lg:w-1/2">
                <h2 className="text-2xl font-semibold text-gray-700 text-center">Expense Track</h2>
